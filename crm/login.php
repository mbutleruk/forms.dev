					...
					<form method="post" action="login.php" id="login-form">
						...
						<div class="question">
		 				...
		 				<div class="question">
							...
							<a class="btn btn-primary right" href="javascript:doLogin()">Login</a>
						</div>
					</form>
				</div>
<?php } ?>		
...
<?php if ($lostpassword) { ?>
				<div id="lostpassword" class="login-form">
					<form method="post" action="login.php" id="lostpassword-form">
						<div class="question">
							<label>Enter your email address below to reset your password. A link enabling you to reset your password will be emailed to you.<br/><br/></label>
							...
							<a class="btn right btn-primary" href="javascript:doReset()" >Reset Password</a>
							<a class="btn right btn-danger" href="?lostpassword=false">Cancel</a>
						</div>
					</form>
				</div>
<?php } ?>
				...
				<div id="resetpassword" class="login-form">
					<form method="post" action="login.php" id="resetpassword-form">
						<div class="question">
							...
							<a class="btn right btn-primary" href="javascript:doContinue()" >Continue</a>
						</div>
					</form>
				</div>
<?php } ?>
				...
				<div id="changepassword" class="login-form">
					<form method="post" action="login.php" id="changepassword-form">
						<div class="question">
							...
							<p class="text-error"><?php echo $errormessage; ?></p>
							<a class="btn right btn-primary" href="javascript:doChange()" >Change Password</a>
							<a class="btn right btn-danger" href="login.php">Cancel</a>
						</div>
					</form>
				</div>
<?php } ?>
				...
				<div id="passwordchanged" class="login-form">
					<form method="post" action="login.php" id="resetpassword-form">
						<div class="question">
							...
							<a class="btn right btn-primary" href="javascript:doChanged()" >Login</a>
						</div>
					</form>
			</div>
<?php } ?>
